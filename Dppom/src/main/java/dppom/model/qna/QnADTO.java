...
public class QnADTO 
{
	...
	public QnADTO(int idx, String id, String qna_pass, String board_type, String title, String content, Date regidate,
			String reply_flag, String reply, Date reply_date) {
		this.idx = idx;
		this.id = id;
	...
	public QnADTO(int idx, String id, String qna_pass, String board_type, String title, String content, Date regidate,
			String reply_flag, String reply, Date reply_date, int rNum) {
		this.idx = idx;
		this.id = id;
		this.qna_pass = qna_pass;
		this.board_type = board_type;
