							...
							<h3>
								<a id="" href="Review?PageURL=Review"
									style="text-decoration: none; color: #6c727a;"><b> <img
										src="./resources/bootstrap3.3.7/images/전0_클릭.PNG" alt="" /></b></a>
							</h3>
						</div>
						<div class="col-md-6">
							<h3>
								<a id="" href="LibReview?PageURL=LibReview"
									...
									src="./resources/bootstrap3.3.7/images/교양0.PNG" alt="교양" /></a>
							</h3>
						</div>
					</div>
				</div>
							...
							<div class="row">
								...
								<div class="col-md-6 input-group">
									<span class="input-group-addon"><i
										...
										type="hidden" name="filename" value="Review" />
