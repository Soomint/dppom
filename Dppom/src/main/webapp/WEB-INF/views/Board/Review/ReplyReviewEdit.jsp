							...
							<c:forEach items="${replyData}" var="re">
								...
								<tr>
									...
									<c:if test="${param.reply_idx eq re.idx}">
										<form action="ReplyEditAction" name="replyform"
											onsubmit="return replyCheck();">
											<td colspan="3"><input type="hidden" name="reply_idx"
												...
												type="text" name="content" style="width: 600px;"
												value="${re.content}" />&nbsp;&nbsp;
												<button class="btn btn-info" style="height: 37px;">수정하기</button>&nbsp;&nbsp;
												<button type="button" class="btn btn-warning"
													onclick="history.back()" style="height: 37px;">Back</button>
											</td>
										</form>
									</c:if>
									<c:if test="${param.reply_idx ne re.idx}">
