			...
			<div class="row row-bottom-padded-lg" id="about-us">
				<div class="col-md-12 section-heading text-center to-animate">
					<div class="row">
						<div class="col-md-4">
							<h3>
								<a id="" href="DataList?PageURL=DataList"
									style="text-decoration: none; color: #6c727a;"> <b><img
										src="./resources/bootstrap3.3.7/images/솔루션_클릭.png" alt="" /></b></a>
							</h3>
						</div>
						<div class="col-md-4">
							<h3>
								<a id="" href="report?PageURL=report"
									style="text-decoration: none; color: #6c727a;"> <img
									src="./resources/bootstrap3.3.7/images/레포트.png" alt="" /></a>
							</h3>
						</div>
						<div class="col-md-4">
							<h3>
								<a id="" href="Detc?PageURL=Detc"
									style="text-decoration: none; color: #6c727a;"> <img
									src="./resources/bootstrap3.3.7/images/ETC_Party.png" alt="" /></a>
							</h3>
						</div>
					</div>
				</div>
						...
						<table id="commu_table" class="table table-hover table-bordered">
							<thead>
								<tr>
									...
									<th style="width: 10%; text-align: center;">파일</th>
									...
									<c:otherwise>
										<c:forEach items="${listRows}" var="row" varStatus="loop">
											...
											<tr>
												...
												<c:if test="${sessionScope.login_id.certi_flag eq 'O' }">
													<td><a
														href="./DataView?idx=${row.idx }&nowPage=${nowPage}&category=${row.category}&filename=${filename}"
												...
												<td width="10%"><span class="glyphicon glyphicon-file"
													style="text-align: right; color: #47C83E"></span></td>
               ...
               <%}//else문 끝 %>    --%>
						...
						<!-- 테이블 E  -->
						<!-- 검색 S -->
						<form name="searchFrm" action="<c:url value="searchDataAction"/>"
