...
<%
	...
	int totalRecordCount = dao.getTotalRecordCount2(map);
	int pageSize = 5;
	int blockPage = 5;
	...
	List<QnADTO> qnaData = dao.selectAll2(map);
	dao.close();
%>
				...
				<div class="col-md-12 to-animate">
					<div class="row">
						<div class="col-sm-6 text-left">
							건의사항 <select name="category" onchange="change();">
								<option value="all">모두보기 이동</option>
								<option value="false" selected>답변안한 건의사항 보기 이동</option>
							</select>
						</div>
					...
					<div class="text-center">
                     ...
                     %>
						...
						<table width="100%">
							<tr>
								<td style="text-align: center;"><%=PagingUtil.pagingImg(totalRecordCount, pageSize, blockPage, nowPage, "qnaadminfalse.jsp?" + addQueryString) %>
								</td>
							</tr>
						</table>
						<form action="qnaadminfalse.jsp">
