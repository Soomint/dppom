		...
		<div class="container">
			...
			<div class="row row-bottom-padded-lg" id="about-us">
				...
				<select name="cate" onchange="location.href=this.value"
					...
					<option value="pointMinus.jsp?id=<%=id%>" selected>차감</option>
				</select>
				...
				<table width="100%;">
					<tr>
						<td style="text-align: center;">
							<!-- ◀◀ ◀ 1 2 3 4 5 ▶ ▶▶   --> <%=PagingUtil.pagingImg(totalRecordCount, pageSize, blockPage, nowPage, "pointMinus.jsp?")%>
